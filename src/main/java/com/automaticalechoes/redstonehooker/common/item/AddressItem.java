    ...
    public Component getName(ItemStack p_41458_) {
        ...
        if(tag.contains(ADDRESS_ENTITY_ID) && tag.contains(ADDRESS_ENTITY_CUSTOM_NAME)){
            ...
            return Component.empty()
                    .append(Component.translatable("redstonehooker.tab.proxy_target").withStyle(Style.EMPTY.withColor(getTypeColor(p_41458_) | 0x8F0C8F)))
            ...
            return Component.empty()
                    .append(Component.translatable("redstonehooker.tab.address").withStyle(Style.EMPTY.withColor(getTypeColor(p_41458_) | 0x8F0C8F)))
