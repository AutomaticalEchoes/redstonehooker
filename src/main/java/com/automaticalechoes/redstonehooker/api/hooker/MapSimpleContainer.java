...
public class MapSimpleContainer extends SimpleContainer {
    private final int size;
    private final NonNullList<ItemStack> items;
    @Nullable
    private List<ContainerListener> listeners;

    public MapSimpleContainer(int size ,NonNullList<ItemStack> mapItemStackList) {
        this.size = size;
        this.items = mapItemStackList;
    }
